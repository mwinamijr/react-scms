        ...
        <div className="row g-5">
          <div className="col-md-6">
            ...
            <ul className="list-unstyled">
              <li><Link to="/getting-started/teachers">Walimu</Link></li> <hr className='mb-0 mt-0' />
              <li><Link to="/getting-started/parents">Wazazi</Link></li> <hr className='mb-0 mt-0' />
              <li><Link to="/getting-started/developers">Developers</Link></li> <hr className='mb-0 mt-0' />
            </ul>
          </div>
          ...
          <div className="col-md-6">
            ...
            <ul className="list-unstyled">
              <li className=''><Link to="https://github.com/mwinamijr/react-scms">React School Management System</Link> Github repository</li> <hr className='mb-0 mt-0' />
              <li className=''>
